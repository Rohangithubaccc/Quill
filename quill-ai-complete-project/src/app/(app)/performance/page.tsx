      ...
      {!loading && publishedPieces.length > 0 && (
        <div style={{ background:'#1e1e28', border:'1px solid #2a2a3a', borderRadius:'12px', padding:'20px', marginBottom:'20px' }}>
          <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'14px', flexWrap:'wrap', gap:'10px' }}>
            ...
            {gscConnected === false && (
              <button onClick={() => window.location.href = '/api/integrations/gsc/connect'} style={{ fontSize:'12px', color:'#6c63ff', fontWeight:600, textDecoration:'none', background:'rgba(108,99,255,0.1)', border:'1px solid rgba(108,99,255,0.25)', borderRadius:'6px', padding:'5px 12px', cursor:'pointer', fontFamily:'Inter, sans-serif' }}>
                Connect GSC →
              </button>
            )}
          </div>
          ...
          {gscConnected === false ? (
            <div style={{ background:'#0f0f13', border:'1px dashed #2a2a3a', borderRadius:'10px', padding:'24px', textAlign:'center' }}>
              ...
              <button onClick={() => window.location.href = '/api/integrations/gsc/connect'} style={{ display:'inline-block', background:'#6c63ff', color:'#fff', borderRadius:'8px', padding:'9px 20px', fontSize:'13px', fontWeight:600, textDecoration:'none', border:'none', cursor:'pointer', fontFamily:'Inter, sans-serif' }}>
