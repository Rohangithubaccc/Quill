...
const INTEGRATIONS_META = [
  ...
  // The callback handler, error-code mapping, and Performance page's
  // ranking panel all already assumed this card existed — the OAuth
  // backend (connect/callback/data routes) was fully built and working,
  // but no entry here meant there was never an actual "Connect" button
  // anywhere in the app. The Performance page's own "Connect Google
  // Search Console" button linked to /settings?tab=integrations, which
  // had nothing to click — a dead loop with no way to reach the
  // already-working backend. Confirmed via screenshot during Stage 4.
  { provider:'gsc',       name:'Google Search Console', icon:'🔍', type:'oauth', note:'', desc:'See which keywords your published posts rank for.' },
